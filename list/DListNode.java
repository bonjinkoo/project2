...
public class DListNode extends ListNode {
	...
	public void insertAfter(Object item) throws InvalidNodeException {
		...
		if (myList.length() == 0) {
			...
			this.next = new DListNode(item, (DList) myList, this, this.next);
	...
	/**
	 * newNode insertBefore() inserts an item immediately preceding this node.
	...
	public void insertBefore(Object item) throws InvalidNodeException {
		...
		if (myList.length() == 0) {
			...
			this.prev = new DListNode(item, (DList) myList, this.prev, this);
